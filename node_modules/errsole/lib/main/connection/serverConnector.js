...
ServerConnector.attachMethods = function (connection, debuggerSessionId, forkedProcess, executeCodeRestricted) {
  var debugAPI = new DebugAPI(connection, debuggerSessionId, forkedProcess, executeCodeRestricted);
  ...
  Server.register('com.errsole.module.debugger_session.'+debuggerSessionId+'.cancel_request', async function(...args) {
    try {
      var result = debugAPI.cancelRequest(...args);
      return result;
    } catch(e) {
      console.error(e);
    }
