...
function wrapExpressInNest(_express) {
...
function wrapExpressSessionInNest(_session) {
...
NestHook.packages = [{
    name: 'express',
    wrapper: wrapExpressInNest
  }, {
    name: 'express-session',
    wrapper: wrapExpressSessionInNest
  }
];

module.exports = NestHook;
