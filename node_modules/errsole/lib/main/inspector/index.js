...
function Debugger(debugPort, debuggerSessionId, forkedProcess, executeCodeRestricted) {
...
Debugger.prototype.attachRegisterHandler = function () {
  ServerConnector.attachMethods(this._connection, this._debuggerSessionId, this._forkedProcess, this._executeCodeRestricted);
}
